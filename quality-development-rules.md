...
* Features must not be pushed directly into the GA release bypassing the above  
  ...
  * Or simply remember that previews happen in mid-March/mid-June/mid-September/mid-December, innovation releases — in early February, early May, early August, early November, see [mariadb-release-model](https://mariadb.com/docs/release-notes/community-server/about/release-model).  
...
* Don't push into the red (in buildbot) branch  
  ...
  * Eventually buildbot will evolve to simply not let you do this  
