...
Stewards hold maintainer-level rights across the whole server without being tied to a single subsystem. They take part in project-wide decisions and can act as tie-breaker in maintainer disputes. The current stewards are:
...
Additionally not retired subsystems list:
...
* **Scope:** The MariaDB Server core and any code not owned by a more specific subsystem listed below.  
* **Status:** Active  
* **Jira project / component:** MDEV /  
* **Maintainers:**  
  * [Oleksandr "Sanja" Byelkin](https://github.com/sanja-byelkin) — MariaDB plc

---

#### **Optimizer**

* **Scope:** subset of files in sql/  
* **Status:** Active  
* **Jira project / component:** MDEV / Optimizer\*  
* **Maintainers:**  
  * [Sergei Petrunia](https://github.com/spetrunia) — MariaDB plc
...
* **Scope:** subset of files in sql/  
* **Status:** Active  
* **Jira project / component:** MDEV / Replication  
* **Maintainers:**  
  * [Brandon Nesterenko](https://github.com/bnestere) — MariaDB plc  
  * [Kristian Nielsen](https://github.com/knielsen) — Community

---

#### **Galera / wsrep**

* **Scope:** sql/wsrep\_\*, wsrep-lib/, galera library in a [separate repo](https://github.com/MariaDB/galera)
* **Status:** Active  
* **Jira project / component:** MDEV / galera\*, wsrep  
* **Maintainers:**  
  * [Seppo Jaakola](https://github.com/sjaakola) — MariaDB plc

---

#### **InnoDB**

* **Scope:** storage/innobase/  
* **Status:** Active  
* **Jira project / component:** MDEV / Storage Engine \- InnoDB  
* **Maintainers:**  
  * [Marko Mäkelä](https://github.com/dr-m) — MariaDB plc

---

#### **RocksDB**

* **Scope:** storage/rocksdb  
* **Status:** Maintained  
* **Jira project / component:** MDEV / Storage Engine \- RocksDB  
* **Maintainers:**  
  * [Sergei Petrunia](https://github.com/spetrunia) — MariaDB plc
...
* **Scope:** storage/duckdb  
* **Status:** Active  
* **Jira project / component:** MDEV / Storage Engine \- DuckDB  
* **Maintainers:**  
  * [Roman Nozdrin](https://github.com/drrtuy) — MariaDB plc

---

#### **ColumnStore**

* **Scope:** storage/columnstore  
* **Status:** Active  
* **Jira project / component:** MCOL  
* **Maintainers:**  
  * [Roman Nozdrin](https://github.com/drrtuy) — MariaDB plc
...
* **Scope:** optimizer, subset of files in sql/  
* **Status:** Active  
* **Jira project / component:** CONC  
* **Maintainers:**  
  * [Georg Richter](https://github.com/9EOR9) — MariaDB plc

---

#### **TokuDB**

* **Scope:** storage/tokudb  
* **Status:** Retired in 10.5
